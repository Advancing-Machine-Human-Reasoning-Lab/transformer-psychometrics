...
def get_args():
    ...
    # for specifying which combined train set this is using
    parser.add_argument('--experiment',help='snli+mnli or snli+mnli+anli?')
    # for specifying whether to use snli+mnli or snli+mnli+anli
    parser.add_argument('--anli', action='store_true',help='If true, will use combined snli+mnli+anli dataset')
    parser.add_argument('--no-train', action='store_false', help='Pass for zero-shot evaluation (no training)')
